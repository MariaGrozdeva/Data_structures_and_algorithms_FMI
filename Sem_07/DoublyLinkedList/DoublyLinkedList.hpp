...
public:
	...
	public:
		DoublyLinkedListIterator(Node* currentElementPtr = nullptr) : currentElementPtr(currentElementPtr)
		{}
		...
		bool operator==(const DoublyLinkedListIterator& rhs) const { return currentElementPtr == rhs.currentElementPtr; }
		bool operator!=(const DoublyLinkedListIterator& rhs) const { return !(*this == rhs); }
	};
